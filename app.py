...
# Sidebar inputs
start_date = st.sidebar.date_input("Start date", datetime.datetime(2023, 1, 1))
...
# st.write("Filtered Total Sales Data for Chart", total_sales)
st.header('Total sales by Vendor')
st.markdown("""
### Total Sales
...
# st.write("Filtered Total Sales Data", filtered_sales)
# st.write("Data Types of Filtered Sales Data", filtered_sales.dtypes)
# Create the chart
